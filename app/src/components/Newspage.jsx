...
let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=b8a5d1cb94834039810359d8d81e790f&page=${this.state.page+1}&pageSize=${this.props.pageSize}`
...
let url = `https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=b8a5d1cb94834039810359d8d81e790f&page=${this.state.page+1}&pageSize=${this.props.pageSize}`;
...
let url = `https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=b8a5d1cb94834039810359d8d81e790f&page=${this.state.page-1}&pageSize=${this.props.pageSize}`;
  ...
  <button className="btn btn-danger" type="button" onClick={this.handleNext}   disabled={this.state.page >= Math.ceil(this.state.totalResults / this.props.pageSize)}
 >Next &raquo;</button>
</div>
